...
class DosenController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'nidn'            => ['nullable', 'string', Rule::unique('users', 'nidn')->where('status_aktif', true)],
            ...
            'tipe_honorarium' => 'nullable|string|max:255',
            'nominal_honor'   => 'nullable',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'nidn'            => ['nullable', 'string', Rule::unique('users', 'nidn')->where('status_aktif', true)->ignore($id)],
            'nip'             => 'nullable|string|max:255',
            'gelar_depan'     => 'nullable|string|max:255',
            'gelar_belakang'  => 'nullable|string|max:255',
            'program_studi'   => 'nullable|string|max:255',
            ...
            'username'        => ['nullable', 'max:255', Rule::unique('users', 'username')->ignore($id)],
            'tgl_lahir'       => 'nullable|date',
            'tgl_join'        => 'nullable|date',
            'gender'          => 'nullable',
            'jabatan_id'      => 'nullable',

...
<div class="row">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">Tentukan titik koordinat pada peta atau otomatis menggunakan GPS</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-5">
        <div class="card p-4">
            ...
            <form method="post" action="{{ url('/lokasi-kantor/tambah-proses') }}" id="form-lokasi">
                @csrf
                <div class="form-group mb-3">
                    <label for="nama_lokasi" class="fw-bold text-muted mb-1">NAMA LOKASI</label>
                    <input type="text" class="form-control @error('nama_lokasi') is-invalid @enderror" id="nama_lokasi" name="nama_lokasi" placeholder="Contoh: Kantor Pusat, Gedung Rektorat..." value="{{ old('nama_lokasi') }}" required autofocus>
                    @error('nama_lokasi')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('lat_kantor') is-invalid @enderror" id="lat_kantor" name="lat_kantor" value="{{ old('lat_kantor', '1.108750') }}" required>
                            @error('lat_kantor')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('long_kantor') is-invalid @enderror" id="long_kantor" name="long_kantor" value="{{ old('long_kantor', '104.082806') }}" required>
                            @error('long_kantor')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control @error('radius') is-invalid @enderror" id="radius" name="radius" value="{{ old('radius', '100') }}" placeholder="100" required min="5">
                    @error('radius')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <select name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror selectpicker" data-live-search="true" required>
                        ...
                        <option value="Office" {{ 'Office' == old('keterangan') ? 'selected="selected"' : '' }}>Office</option>
                        <option value="Patroli" {{ 'Patroli' == old('keterangan') ? 'selected="selected"' : '' }}>Patroli</option>
                    </select>
                    @error('keterangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <button type="submit" class="btn btn-primary w-100 py-3 fw-bold" style="border-radius: 8px; font-size: 16px;">
                    <i class="fa fa-save me-2"></i> Simpan Lokasi Kantor
                </button>
            </form>
        </div>
    </div>
    ...
    <div class="col-lg-7">
        <div class="card p-3">
            <div class="alert alert-info py-2 px-3 mb-3 d-flex align-items-center" style="border-radius: 8px; font-size: 13px;">
                ...
                <span><b>Tips:</b> Klik sembarang titik pada peta atau geser penanda biru untuk mengubah titik koordinat secara otomatis. Lingkungan berwarna biru menunjukkan radius absensi.</span>
            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var map = L.map('map-preview').setView([defaultLat, defaultLng], 16);

            ...
            <div class="tf-container">
                <div class="tf-topbar d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <a href="{{ url('/notifications') }}" class="icon-notification1" id="bell-notif-box">
                            <span id="bell-notif-badge" style="display: {{ auth()->user()->notifications()->whereNull('read_at')->count() > 0 ? 'inline-block' : 'none' }}">

    ...
    <div class="col-md-8">
        <div class="card" style="border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.02);">
            ...
            <div class="card-body" style="padding: 24px;">
                ...
                <form action="{{ url('/skema-honorarium/'.$skema->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="nama_skema" id="nama_skema" class="form-control" required value="{{ old('nama_skema', $skema->nama_skema) }}" placeholder="Contoh: Honor Asisten Ahli S1" style="border-radius: 12px; padding: 12px 16px; background-color: #f8fafc; border: 1px solid #cbd5e1;">
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nominal_per_unit" id="nominal_per_unit" class="form-control format-rupiah" required value="{{ old('nominal_per_unit', number_format($skema->nominal_per_unit, 0, ',', '.')) }}" placeholder="Contoh: 150.000" style="border-radius: 0 12px 12px 0; padding: 12px 16px; background-color: #f8fafc; border: 1px solid #cbd5e1;">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control" placeholder="Tuliskan keterangan detail skema honorarium..." style="border-radius: 12px; padding: 12px 16px; background-color: #f8fafc; border: 1px solid #cbd5e1;">{{ old('deskripsi', $skema->deskripsi) }}</textarea>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-5">
                        ...
                        <button type="submit" class="btn btn-primary" style="border-radius: 12px; font-weight: 600; padding: 12px 24px; box-shadow: 0 4px 12px rgba(79, 70, 229, 0.2);">Perbarui Skema</button>
                    </div>
                </form>
            </div>
        </div>

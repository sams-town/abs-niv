            ...
            <div class="card">
                <form method="post" class="p-4" action="{{ url('/shift/'.$shift->id) }}">
                    ...
                    @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                <label for="jam_mulai_istirahat" class="float-left">Jam Mulai Istirahat</label>
                                <input type="text" class="form-control clockpicker @error('jam_mulai_istirahat') is-invalid @enderror" id="jam_mulai_istirahat" name="jam_mulai_istirahat" autofocus value="{{ old('jam_mulai_istirahat', $shift->jam_mulai_istirahat) }}">
                            ...
                            <div class="col">
                                <label for="jam_selesai_istirahat" class="float-left">Jam Selesai Istirahat</label>
                                <input type="text" class="form-control clockpicker @error('jam_selesai_istirahat') is-invalid @enderror" id="jam_selesai_istirahat" name="jam_selesai_istirahat" autofocus value="{{ old('jam_selesai_istirahat', $shift->jam_selesai_istirahat) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0" max="480" step="1"
                                           ...
                                           value="{{ old('toleransi', $shift->toleransi ?? 0) }}"

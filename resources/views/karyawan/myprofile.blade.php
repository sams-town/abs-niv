                            ...
                            <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="datetime" class="form-control @error('tgl_join') is-invalid @enderror" id="tgl_join" name="tgl_join" value="{{ old('tgl_join', $karyawan->tgl_join) }}" disabled>
                                        @error('tgl_join')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <select disabled class="form-control selectpicker @error('role') is-invalid @enderror" id="role" name="role[]" multiple>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="datetime" class="form-control @error('tanggal_mulai_pkwt') is-invalid @enderror" id="tanggal_mulai_pkwt" name="tanggal_mulai_pkwt" value="{{ old('tanggal_mulai_pkwt', $karyawan->tanggal_mulai_pkwt) }}" disabled>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="datetime" class="form-control @error('tanggal_berakhir_pkwt') is-invalid @enderror" id="tanggal_berakhir_pkwt" name="tanggal_berakhir_pkwt" value="{{ old('tanggal_berakhir_pkwt', $karyawan->tanggal_berakhir_pkwt) }}" disabled>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-4">
                                        ...
                                        <input type="datetime" class="form-control @error('masa_berlaku') is-invalid @enderror" id="masa_berlaku" name="masa_berlaku" value="{{ old('masa_berlaku', $karyawan->masa_berlaku) }}" disabled>
                                        @error('masa_berlaku')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_cuti') is-invalid @enderror" id="izin_cuti" name="izin_cuti" value="{{ old('izin_cuti', $karyawan->izin_cuti) }}" readonly>
                                        @error('izin_cuti')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_lainnya') is-invalid @enderror" id="izin_lainnya" name="izin_lainnya" value="{{ old('izin_lainnya', $karyawan->izin_lainnya) }}" readonly>
                                        @error('izin_lainnya')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_telat') is-invalid @enderror" id="izin_telat" name="izin_telat" value="{{ old('izin_telat', $karyawan->izin_telat) }}" readonly style="background-color:white">
                                        @error('izin_telat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col mb-4">
                                        ...
                                        <input type="number" class="form-control @error('izin_pulang_cepat') is-invalid @enderror" id="izin_pulang_cepat" name="izin_pulang_cepat" value="{{ old('izin_pulang_cepat', $karyawan->izin_pulang_cepat) }}" readonly style="background-color:white">

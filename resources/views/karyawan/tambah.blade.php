...
@section('isi')
    ...
    <form id="tambahPegawaiForm" method="POST" action="{{ url('/pegawai/tambah-pegawai-proses') }}" enctype="multipart/form-data">
        @csrf

        <!-- Top Header Card -->
        <div class="tambah-pegawai-header">
            <div class="header-left">
                <a href="{{ url('/pegawai') }}" class="btn-back-circle">
                    <i class="fa fa-arrow-left"></i>
                </a>
                <div class="header-title-wrapper">
                    <h3>Tambah Pegawai</h3>
                    <p>Data lengkap pegawai baru</p>
                </div>
            </div>
            <div class="header-right">
                <a href="{{ url('/pegawai') }}" class="btn-cancel">
        ...
        <div class="form-card">
            ...
            <div class="tab-content-section" id="section-data-pribadi">
                <div class="section-title">
                    <i class="fa fa-image"></i> Foto Pegawai
                </div>
            ...
            <div class="tab-content-section d-none" id="section-kontrak-rekening">
                <div class="section-title">
                    <i class="fa fa-file-signature"></i> Kontrak Kerja
                </div>
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <label for="no_pkwt">NIP <span class="required-star">*</span></label>
                        <input type="text" class="form-control" name="no_pkwt" id="no_pkwt" placeholder="Nomor Induk Pegawai">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="tab-content-section d-none" id="section-penjumlahan-gaji">
                <div class="section-title">
                    <i class="fa fa-money-bill-wave"></i> Penjumlahan Gaji (Earnings)
                </div>
                <div class="row g-3 mb-2">
                    <div class="col-md-6">
                        <label for="gaji_pokok">Gaji Pokok <span class="required-star">*</span></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control format-rupiah" name="kehadiran" id="kehadiran" value="0">
                    </div>
                    <div class="col-md-6">
                        <label for="thr">THR</label>
                        <input type="text" class="form-control format-rupiah" name="thr" id="thr" value="0">
                    </div>
                    <div class="col-md-6">
                        <label for="bonus_pribadi">Bonus Pribadi</label>
                        <input type="text" class="form-control format-rupiah" name="bonus_pribadi" id="bonus_pribadi" value="0">
                    </div>
                    <div class="col-md-6">
                        <label for="bonus_team">Bonus Team</label>
                        <input type="text" class="form-control format-rupiah" name="bonus_team" id="bonus_team" value="0">
                    </div>
                    <div class="col-md-6">
                        <label for="bonus_jackpot">Bonus Jackpot</label>
                        <input type="text" class="form-control format-rupiah" name="bonus_jackpot" id="bonus_jackpot" value="0">
                    </div>
                </div>
            </div>
                ...
                <div class="deduction-card-wrapper">
                    ...
                    <div class="deduction-card">
                        <div class="deduction-header">
                            <span class="deduction-label">terlambat <span class="required-star">*</span></span>
                    ...
                    <div class="deduction-card">
                        ...
                        <div class="deduction-input-group">
                            <input type="number" class="deduction-input no-prefix" name="batas_terlambat" id="batas_terlambat" value="5">
                        </div>
                    </div>
                    ...
                    <div class="deduction-card">
                        <div class="deduction-header">
                            <span class="deduction-label">mangkir <span class="required-star">*</span></span>
                            <span class="deduction-badge">/ Unit</span>
                        </div>
                        <div class="deduction-input-group">
                            <span class="deduction-prefix">Rp</span>

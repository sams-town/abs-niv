        ...
        <div class="card pegawai-header-card">
            <div class="row align-items-center">
                <div class="col-md-5 mt-2 p-0">
                    ...
                    <p class="pegawai-subtitle">Kelola dan pantau seluruh dosen</p>
                </div>
                <div class="col-md-7 p-0">
                    <div class="action-buttons-group">
                        ...
                        <button type="button" class="btn btn-outline-import" data-bs-toggle="modal" data-bs-target="#importDosenModal">
                            <i class="fa fa-upload me-2"></i> Import Dosen
                        </button>
                        <a href="{{ url('/dosen/export') }}{{ $_GET ? '?'.$_SERVER['QUERY_STRING'] : '' }}" class="btn btn-outline-export">
                            <i class="fa fa-download me-2"></i> Export
                        </a>
                        <a href="{{ url('/shift') }}" class="btn btn-outline-shift">
                            <i class="fa fa-clock me-2"></i> Shift
                        </a>
                        <a href="{{ url('/dosen/tambah') }}" class="btn btn-solid-tambah">
                    ...
                    <div class="table-responsive" style="border-radius: 10px">
                        <table class="table table-bordered" style="vertical-align: middle">
                            ...
                            <tr>
                                ...
                                <th style="min-width: 170px; background-color:rgb(243, 243, 243);" class="text-center">NIDN</th>
                                <th style="min-width: 170px; background-color:rgb(243, 243, 243);" class="text-center">Jabatan Akademik</th>
                                <th style="min-width: 170px; background-color:rgb(243, 243, 243);" class="text-center">Mata Kuliah</th>
                                <th style="min-width: 170px; background-color:rgb(243, 243, 243);" class="text-center">Email</th>
                                <th style="min-width: 170px; background-color:rgb(243, 243, 243);" class="text-center">Telepon</th>
                            ...
                            <tr>
                                ...
                                <td style="position: sticky; left: 40px; background-color: rgb(235, 235, 235); z-index: 1;">{{ $d->name }}</td>
                                <td class="text-center">{{ $d->nidn ?? '-' }}</td>
                                <td class="text-center">{{ $d->jabatan_akademik ?? '-' }}</td>
                                <td class="text-center">{{ $d->mata_kuliah ?? '-' }}</td>
                                <td class="text-center">{{ $d->email ?? '-' }}</td>
                                <td class="text-center">{{ $d->telepon ?? '-' }}</td>
    ...
    <div class="resapan-drawer" id="resapanDrawer">
        ...
        <div class="drawer-header">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 style="margin: 0; font-size: 18px; font-weight: 700; color: #0f172a;">Analisis Resapan Dosen</h4>
                    <p style="margin: 4px 0 0; font-size: 12px; color: #64748b;">Visualisasi distribusi dosen berdasarkan lokasi dan domisili</p>
                </div>
            </div>
